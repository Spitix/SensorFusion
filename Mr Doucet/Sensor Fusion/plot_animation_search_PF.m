function plot_animation_search_PF(N_plots,C_loop,x_t_vec,x_vec,psi,r_est_l,r_est_h,centre_geo_circle,radius_geo_circle,x_state,k_obs,N_loops_fb,p_e,r_d,psi_jammer,particles)
...
%   All plot handles
persistent h_uav_plot h_jammer_plot h_uav_trace_plot h_uav_jammer_vec_plot h_r_est_plot h_geo_est_plot h_state_pos_est h_loiter_plot particles_plot
...
function plot_particles(particles)
    global plot_scaling particles_plot
    if isempty(particles_plot)
        particles_plot = plot(particles(1,:)/plot_scaling,particles(2,:)/plot_scaling,'.y','markersize',1);
    else
        delete(particles_plot);
        particles_plot = plot(particles(1,:)/plot_scaling,particles(2,:)/plot_scaling,'.y','markersize',1);
    end
end
